<header class="sticky top-0 bg-trueGray-300" style="z-index: 900" x-data="dropdown()">
    <div class="container flex items-center justify-between h-16 md:justify-start">
        <a  :class="{'bg-opacity-100 text-orange-500' : open}"
            x-on:click="show()"
            class="flex flex-col items-center justify-center order-last h-full px-6 font-semibold bg-white bg-opacity-25 cursor-pointer text-green md:order-first md:px-4">
    ...
    <nav id="navigation-menu"
        ...
        class="absolute hidden w-full bg-opacity-25 bg-trueGray-300">
